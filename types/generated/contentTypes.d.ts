...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    actionButton: Schema.Attribute.Component<'shared.advanced-link', false> &
    ...
    secondarySectionBackground: Schema.Attribute.Media<
    ...
    sectionTitle: Schema.Attribute.Component<'shared.advanced-heading', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAppFooterAppFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaBtn: Schema.Attribute.Component<'shared.advanced-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    privacyPolicyLink: Schema.Attribute.Component<'shared.basic-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAppHeaderAppHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaBtn: Schema.Attribute.Component<'shared.basic-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    logo: Schema.Attribute.Component<'shared.advanced-heading', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactBoxHeading: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contactBoxImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    contactForm: Schema.Attribute.DynamicZone<['shared.form-field']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contacts_infos: Schema.Attribute.Relation<
      'oneToMany',
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    formActions: Schema.Attribute.Component<'shared.advanced-button', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactsInfoContactsInfo
  extends Struct.CollectionTypeSchema {
  collectionName: 'contacts_infos';
  info: {
    description: '';
    displayName: 'contacts-info';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['LINK', 'TEXT']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCooperationListCooperationList
  extends Struct.CollectionTypeSchema {
  collectionName: 'cooperation_lists';
  info: {
    description: '';
    displayName: 'cooperation-list';
    pluralName: 'cooperation-lists';
    singularName: 'cooperation-list';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    ishasActions: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cooperation-list.cooperation-list'
    >;
    primaryAction: Schema.Attribute.Component<'shared.advanced-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    secondaryAction: Schema.Attribute.Component<'shared.basic-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    colorScheme: Schema.Attribute.Enumeration<
      ['dark light', 'light dark', 'normal', 'only light']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    socialMedia: Schema.Attribute.Component<'shared.seo-open-graph', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    blogShowMoreBtn: Schema.Attribute.Component<'shared.advanced-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    cooperation_lists: Schema.Attribute.Relation<
      'oneToMany',
      'api::cooperation-list.cooperation-list'
    >;
    cooperationDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroAdvancedMobileSubTitle: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    heroAdvancedSubTitle: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    heroAdvancedTitle: Schema.Attribute.Component<
    ...
    privilegeBackgroundImag: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    privilegeDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    privilegePatternImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    privilegePersonImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    privilegeSectionTitle: Schema.Attribute.Component<
      'shared.advanced-heading',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    >;
    servicesContactBtn: Schema.Attribute.Component<'shared.basic-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    servicesSectionTitle: Schema.Attribute.Component<
      'shared.advanced-heading',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    techDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    testimonialsSectionTitle: Schema.Attribute.Component<
      'shared.advanced-heading',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPartnersListPartnersList
  extends Struct.CollectionTypeSchema {
...
export interface ApiTestimonialsListTestimonialsList
  ...
  attributes: {
    authorCover: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cooperation-list.cooperation-list': ApiCooperationListCooperationList;
